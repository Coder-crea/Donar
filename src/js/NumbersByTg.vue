<template>
    ...
    <div class="reg">
        <div class="content">
            ...
            <div class="form">
                <div class="field">
                    <input type="text" class="field-input" placeholder id="number" v-model="this.code">
                    <label for="number" class="field-label">Код</label>
                </div>
                <router-link to=""><button @click="BaseCode(this.code)">Далее</button></router-link>
            </div>
        </div>
    </div>
    <Endter />
...
export default {
    ...
    mounted() {
        this.numer = localStorage.getItem("Number")
    },
    methods:{
        BaseCode(code){
            if(code== ""){
                this.info= "Введите корректнный Код"
            } else {
